...
Activates PSN account on jailbroken PS4 allowing you to export save data to USB among other things. The offsets are for 7.0x fw version.

Requires [ps4debug](https://github.com/ChendoChap/ps4debug) to compile
